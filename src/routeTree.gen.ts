...
import { Route as AppBoardsImport } from './routes/_app/boards'
...
export interface FileRouteTypes {
  ...
  fullPaths: '/' | '' | '/login' | '/register' | '/boards' | '/dashboard'
  fileRoutesByTo: FileRoutesByTo
  to: '/' | '' | '/login' | '/register' | '/boards' | '/dashboard'
  id:
    | '__root__'
    | '/'
    | '/_app'
